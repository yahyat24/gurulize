...
$(document).ready(function() {
  ...
  if (window.location.pathname === "/paketler/" &&
    ...
    $('.list.flex').prepend('<div class="fit-abonelik-wrapper"><div class="fit-abonelik-container"><div class="fit-abonelik-item"><h2 class="fit-h2 fit-color-1">Online Pilates Kampı</h2><div class="fit-sales-card"><div class="fit-sales-con"><div class="fit-sales-item"><div class="fit-sales-content"><div class="fit-sales-img"><img src="/images/202602/342_500x500.png" alt="" width="214" height="197" /></div><div class="fit-sales-excerpt"><h4 class="fit-h4 fit-color-1">Aybüke Özkan</h4><p class="fit-p fit-color-1">Pilates Eğitmeni</p><p class="fit-sales-green fit-color-1">Uzmanlık Alanları:</p><p class="fit-p fit-color-1">Pilates Eğitmeni, Mat pilates, reformer pilates ve temel seviye güçlendirme & esneklik odaklı gzersizler</p></div><div class="fit-sales-bg"><img src="/images/202512/332_302x212.png" alt="" width="302" height="212" /></div></div></div></div></div><p class="fit-pkt-p fit-p fit-color-3">Havale/EFT ile ödeme yapmak için lütfen <a class="havale-link" href="/s/havale">buraya tıklayınız.</a><br />Herhangi bir problem yaşarsanız WhatsApp destek hattımıza ulaşabilirsiniz.</p><div class="fit-camp-wrapper"><div class="fit-camp-container"><div class="fit-camp-item"><div class="fit-camp-items fit-margin-bottom"><div class="fit-camp-col"><div class="fit-camp-content"><div class="fit-camp-title"><h3 class="fit-h3 fit-color-1">Kampın İçeriği</h3><p class="fit-p fit-color-1">Pilates Grubu, düzenli egzersiz alışkanlığı kazanmak ve bedenini daha güçlü, esnek ve dengeli hale getirmek isteyenler için özel olarak tasarlanmış güvenli ve etkili bir online programdır. </p></div><div class="fit-camp-list"><ul><li class="fit-p fit-color-1"><span><i class="fas fa-check-circle"></i></span><p class="">Doğru teknikle uygulanan pilates egzersizleri sayesinde postür desteklenir, core kasları güçlenir ve kas-iskelet sistemi dengeli şekilde çalıştırılır. </p></li><li class="fit-p fit-color-1"><i class="fas fa-check-circle"></i>Haftanın 3 günü canlı derslerle katılımcılar sürdürülebilir bir rutin oluşturur. Satın alma sonrası Telegram gruplarına dahil olan katılımcılar, programla ilgili duyuruları ve bilgilendirmeleri anında alır. </li><li class="fit-p fit-color-1"><i class="fas fa-check-circle"></i>Uzman eğitmen rehberliği ve sürekli iletişim desteği ile katılımcılar motivasyonlarını yüksek tutar, güvenli ve kontrollü şekilde ilerleme kaydeder</li></ul></div></div></div></div><div class="fit-camp-items"><div class="fit-camp-content"><div class="fit-camp-price"><div class="fit-camp-box fit-bg-mor"><a href="/s/deneme-dersi"> <span class="fit-h4 fit-color-2">Ücretsiz</span> <span class="fit-h3 fit-color-2">Deneme Dersi</span> </a></div></div></div></div></div></div></div></p><div class="fit-abonelik-top"></div><div class="fit-abonelik-bottom"><div class="fit-abonelik-card"><div class="fit-card-top fit-bg-mor"><h3 class="fit-h3 fit-color-2">Kamp (Abonelik)</h3></div><div class="fit-card-center fit-bg-green"><h3 class="fit-h3 fit-color-1">6 Aylık Abonelik</h3><p class="fit-p fit-color-3">Aylık olarak ödeme, otomatik çekim ve istediğin zaman iptal etme avantajı.</p><h3 class="fit-h3 fit-color-1">Aylık 1600 &#x20BA</h3><div class="fit-card-btn"><a class="fit-p fit-color-2 fit-button stripe-fitkultur fit-bg-mor" href="https://buy.stripe.com/8x29AT4PyaNS5VwfK63Ru09">Satın Al</a></div></div><div class="fit-card-botton"><ul><li class="fit-p fit-color-3 fit-bold">Yakında Başlayacak.</li><li class="fit-p fit-color-3">Aylık abonelik şeklinde olup, her ay kartınızdan otomatik çekim yapılır</li><li class="fit-p fit-color-3">İndirimli fiyat avantajından yararlanırsınız</li><li class="fit-p fit-color-3">Sabit fiyat garantisi vardır</li><li class="fit-p fit-color-3">Dilediğiniz zaman iptal edebilirsiniz</li></ul></div></div></div></div></div></div>');

    $('.item.gtm-package-item').appendTo('.fit-abonelik-top');
    $('.fit-abonelik-card').appendTo('.fit-abonelik-top');

    $('.list.flex').append('<div class="fit-faq-page"><div class="fit-faq-wp"><div class="fit-faq-container"><h2 class="fit-h2 fit-color-1">Sıkça Sorulan Sorular</h2><div class="accordion"><div class="accordion-item"><button id="accordion-button-1" aria-expanded="false"><span class="accordion-title btn-font fit-p fit-color-1">Ders programınız var mı, varsa gün ve saatleri nedir?</span><span class="fit-icon" aria-hidden="true"></span></button><div class="accordion-content"><p>Canlı derslerimiz, Salı ve Perşembe günleri 20:00 da gerçekleşiyor, canlı derslere katılamayanlar, bir hafta boyunca derslerin tekrarına erişebileceklerdir.</p></div><button id="accordion-button-2" aria-expanded="false"><span class="accordion-title btn-font fit-p fit-color-1">Dersler canlı mı? Saatleri bana uymazsa ne olacak? </span><span class="fit-icon" aria-hidden="true"></span></button><div class="accordion-content"><p>Derslerimizin tamamı canlı olarak gerçekleşmektedir. Ancak saatleri size uymuyorsa endişelenmeyin, tüm derslerin kayıtları bir hafta boyunca erişime açık olur. Katılımcılarımızın çoğu dersleri kayıttan takip ediyor ve bu sistemden oldukça memnun.</p></div><button id="accordion-button-11" aria-expanded="false"><span class="accordion-title btn-font fit-p fit-color-1">Program süresince destek alabilecek miyim?</span><span class="fit-icon" aria-hidden="true"></span></button><div class="accordion-content"><p> Evet. Satın alma sonrası Telegram grubuna dahil olursunuz. Duyurular bu grup üzerinden paylaşılır, uzmanlarla sürekli iletişim kurarak destek alabilirsiniz.</p></div><button id="accordion-button-3" aria-expanded="false"><span class="accordion-title btn-font fit-p fit-color-1">Sağlık sorunlarım var. Katılabilir miyim? </span><span class="fit-icon" aria-hidden="true"></span></button><div class="accordion-content"><p>(Bel-boyun fıtığı, menisküs, sakatlık vb.) Doktorunuz ya da fizyoterapistiniz egzersiz yapmanızı öneriyorsa, bu program sizin için oldukça uygundur. Yine de kafanıza takılan sorular varsa WhatsApp destek hattından bize ulaşabilirsiniz.</p></div><button id="accordion-button-4" aria-expanded="false"><span class="accordion-title btn-font fit-p fit-color-1">Yurt dışında yaşıyorum. Katılabilir miyim? Ödeme nasıl olur?</span><span class="fit-icon" aria-hidden="true"></span></button><div class="accordion-content"><p>Elbette katılabilirsiniz. Yurt dışından birçok katılımcımız var. Ödemelerinizi kredi kartı ile güvenli bir şekilde gerçekleştirebilirsiniz.</p></div><button id="accordion-button-5" aria-expanded="false"><span class="accordion-title btn-font fit-p fit-color-1">Kamera açmamız gerekiyor mu?</span><span class="fit-icon" aria-hidden="true"></span></button><div class="accordion-content"><p>Hayır. Dersler YouTube Live üzerinden yapılıyor ve sadece benim kameram açık oluyor. Egzersizler kolaydan zora doğru ilerlediği için, sizi zorlamadan ve hata yapma riski olmadan ilerlemeniz mümkün. Sürece güvenin!</p></div></div></div></div></div></div>');
